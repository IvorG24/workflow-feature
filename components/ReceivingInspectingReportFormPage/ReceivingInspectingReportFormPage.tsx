...
import WarehouseReceiverList from "./WarehouseReceiverList/WarehouseReceiverList";
...
const ReceivingInspectingReportFormPage = ({
  teamMemberList,
  form,
  warehouseReceivers,
  ...
  const [isCreatingWarehoueReceiver, setIsCreatingWarehouseReceiver] =
    useState(false);
  const [warehouseReceiverList, setWarehouseReceiverList] =
    useState(warehouseReceivers);
  const [warehouseReceiverCount, setWarehouseReceiverCount] = useState(
    warehouseReceiverListCount
  );
  ...
  return (
    <Container>
      ...
      <Paper p="xl" shadow="xs">
        {!isCreatingWarehoueReceiver ? (
          <WarehouseReceiverList
            warehouseReceiverList={warehouseReceiverList}
            setWarehouseReceiverList={setWarehouseReceiverList}
            warehouseReceiverCount={warehouseReceiverCount}
            setWarehouseReceiverCount={setWarehouseReceiverCount}
            setIsCreatingWarehouseReceiver={setIsCreatingWarehouseReceiver}
          />
        ) : null}
        {isCreatingWarehoueReceiver ? (
...
export default ReceivingInspectingReportFormPage;
