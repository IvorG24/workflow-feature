...
const ServicesFormPage = ({
  ...
  const [segmentValue, setSegmentValue] =
    useState<FormSegmentType>("Form Preview");
  ...
  return (
    <Container>
      ...
      <Center>
        <SegmentedControl
          data={FORM_SEGMENT_CHOCIES.filter(
            (choice) => choice.value !== "Form Details"
          )}
          value={segmentValue}
      ...
      <Space h="xl" />
      <BreadcrumbWrapper breadcrumbItems={servicesFormItems}>
        {!selectedProject && (
          <>
