...
const EquipmentList = ({
  ...
  const handleColumnClick = (equipment_id: string) => {
    const selectedEquipment = equipmentList.find(
      (equipment) => equipment.equipment_id === equipment_id
    );
    setSelectedEquipment(selectedEquipment || null);
  };
      ...
      <DataTable
        ...
        columns={[
          ...
          },
          {
            ...
            title: "Name",
            render: ({ equipment_name, equipment_id }) => (
              <Text
                className={classes.clickableColumn}
                onClick={() => {
                  handleColumnClick(equipment_id);
                }}
              >
                {equipment_name}
              </Text>
          ...
          },
          {
            ...
            title: "Category",
            render: ({ equipment_category, equipment_id }) => (
              <Text
                className={classes.clickableColumn}
                onClick={() => {
                  handleColumnClick(equipment_id);
