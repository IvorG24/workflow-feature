  ...
  return (
    <Container>
      ...
      {segmentValue === "Form Details" ? (
        <Box>
          <BreadcrumbWrapper breadcrumbItems={pedPartEquipmentItems}>
            {!isCreatingEquipment && !editEquipment && !selectedEquipment ? (
              <EquipmentList
      ...
      <Space h="xl" />
      <BreadcrumbWrapper breadcrumbItems={pedPartSignerItems}>
        {!selectedProject && (
          <>
