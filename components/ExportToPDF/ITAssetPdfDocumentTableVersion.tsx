...
const ITAssetPdfDocumentTableVersion = ({
  requestDetails,
  requestorDetails,
  requestIDs,
  requestItems,
  ...
  const assigneeInformation = {
    employee_number: requestItems[requestItems.length - 1].fields[0].value,
    position: requestItems[requestItems.length - 1].fields[1].value,
    full_name: requestItems[requestItems.length - 1].fields[2].value,
    contact_number: requestItems[requestItems.length - 1].fields[3].value,
    email_address: requestItems[requestItems.length - 1].fields[4].value,
  };
        ...
        <Fragment>
          <View>
            ...
            <View style={styles.table}>
              ...
              {requestItems
                .filter((section) => section.title === "Item")
                .map((item, index) => {
                  let description = "";
            ...
            <View style={styles.table}>
              <View style={[styles.tableRow, { backgroundColor: "#A5D8FF" }]}>
                <View style={[styles.tableCol, styles["Signature"]]}>
                  <Text style={styles.tableHeader}>Employee Number</Text>
                </View>
              ...
              <View style={styles.tableRow} wrap={false}>
                <View style={[styles.tableCol, styles["Signature"]]}>
                  <Text style={styles.tableCell}>
                    {assigneeInformation.employee_number}
                  </Text>
                </View>
                <View style={[styles.tableCol, styles["Position"]]}>
                  <Text style={styles.tableCell}>
                    {assigneeInformation.position}
                  </Text>
                </View>
                <View style={[styles.tableCol, styles["Full Name"]]}>
                  <Text style={styles.tableCell}>
                    {assigneeInformation.full_name}
                  </Text>
                </View>
                <View style={[styles.tableCol, styles["Full Name"]]}>
                  <Text style={styles.tableCell}>
                    {assigneeInformation.contact_number}
                  </Text>
                </View>
                <View style={[styles.tableCol, styles["Full Name"]]}>
                  <Text style={styles.tableCell}>
                    {assigneeInformation.email_address}
                  </Text>
                </View>
              </View>
            </View>
...
export default ITAssetPdfDocumentTableVersion;
