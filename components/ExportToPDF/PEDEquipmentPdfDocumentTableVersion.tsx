...
type ColumnType = "Category" | "Equipment Name" | "Brand" | "Model";

const columnList = ["Category", "Equipment Name", "Brand", "Model"];
...
const PEDEquipmentPdfDocumentTableVersion = ({
  requestDetails,
  requestorDetails,
  requestIDs,
  requestItems,
          ...
          <View>
            ...
            <View style={styles.table}>
              <View style={[styles.tableRow, { backgroundColor: "#A5D8FF" }]}>
                ...
                <View style={[styles.tableCol, styles["Equipment Name"]]}>
...
export default PEDEquipmentPdfDocumentTableVersion;
