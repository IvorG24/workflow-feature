...
const AuditFormPage = ({
  ...
  const [isCreatingAuditProcessor, setIsCreatingAuditProcessor] =
    useState(false);
  const [auditProcessorList, setAuditProcessorList] = useState(auditProcessors);
  const [auditProcessorCount, setAuditProcessorCount] = useState(
    auditProcessorListCount
  );
  ...
  return (
    <Container>
      ...
      <Paper p="xl" shadow="xs">
        {!isCreatingAuditProcessor ? (
          <AuditProcessorList
            auditProcessorList={auditProcessorList}
            setAuditProcessorList={setAuditProcessorList}
            auditProcessorCount={auditProcessorCount}
            setAuditProcessorCount={setAuditProcessorCount}
            setIsCreatingAuditProcessor={setIsCreatingAuditProcessor}
          />
        ) : null}
        {isCreatingAuditProcessor ? (
