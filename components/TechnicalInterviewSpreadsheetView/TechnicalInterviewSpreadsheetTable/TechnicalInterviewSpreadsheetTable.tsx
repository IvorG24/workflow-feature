            ...
            <thead>
              <tr>
                ...
                {!hiddenColumnList.includes(
                  ...
                  <th>
                    <Flex gap="xs" align="center" justify="center" wrap="wrap">
                      ...
                      {sortButtons("technical_interview_date_created")}
                    </Flex>
                  </th>
                )}
                {!hiddenColumnList.includes("technical_interview_status") && (
                  <th>
                    <Flex gap="xs" align="center" justify="center" wrap="wrap">
                      <Text>Technical Interview Status</Text>
                      {sortButtons("technical_interview_status")}
                    </Flex>
                  </th>
                )}
                {!hiddenColumnList.includes("technical_interview_schedule") && (
                  <th>
                    <Flex gap="xs" align="center" justify="center" wrap="wrap">
                      <Text>Technical Interview Schedule</Text>
                      {sortButtons("technical_interview_schedule")}
                    </Flex>
                  </th>
                )}
