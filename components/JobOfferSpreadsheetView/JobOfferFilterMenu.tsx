import { JobOfferFilterFormValues, OptionType } from "@/utils/types";
import {
  Accordion,
  Button,
  Drawer,
...
const JobOfferFilterMenu = ({
  ...
  const { handleSubmit, control, register } =
    useFormContext<JobOfferFilterFormValues>();
      ...
      >
        ...
        >
          <Stack spacing="xs" sx={{ overflow: "hidden" }}>
            <Accordion variant="contained" defaultValue="Job Offer">
              ...
              <Accordion.Item value="Job Offer">
                <Accordion.Control>Job Offer</Accordion.Control>
                <Accordion.Panel>
                  <Stack spacing="xs" sx={{ overflow: "hidden" }}>
                    <Stack spacing={0}>
                      <Text size={14} fw={500}>
                        Job Offer Date Created
                      </Text>
                      <Flex gap="xs">
                        <Controller
                          control={control}
                          name="job_offer_date_created.start"
                          render={({ field: { value, onChange } }) => {
                            const newValue = value
                        ...
                        <Controller
                          control={control}
                          name="job_offer_date_created.end"
                          render={({ field: { value, onChange } }) => {
                            const newValue = value
                              ? new Date(value as string)
                              : null;
...
export default JobOfferFilterMenu;
