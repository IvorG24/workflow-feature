...
const ChequeReferenceFormPage = ({
  ...
  const [isCreatingTreasuryProcessor, setIsCreatingTreasuryProcessor] =
    useState(false);
  const [treasuryProcessorList, setTreasuryProcessorList] =
    useState(treasuryProcessors);
  const [treasuryProcessorCount, setTreasuryProcessorCount] = useState(
    treasuryProcessorListCount
  );
  ...
  return (
    <Container>
      ...
      <Paper p="xl" shadow="xs">
        {!isCreatingTreasuryProcessor ? (
          <TreasuryProcessorList
            treasuryProcessorList={treasuryProcessorList}
            setTreasuryProcessorList={setTreasuryProcessorList}
            treasuryProcessorCount={treasuryProcessorCount}
            setTreasuryProcessorCount={setTreasuryProcessorCount}
            setIsCreatingTreasuryProcessor={setIsCreatingTreasuryProcessor}
          />
        ) : null}
        {isCreatingTreasuryProcessor ? (
          <CreateTreasuryProcessor
            setIsCreatingTreasuryProcessor={setIsCreatingTreasuryProcessor}
            setTreasuryProcessorList={setTreasuryProcessorList}
            setTreasuryProcessorCount={setTreasuryProcessorCount}
          />
...
export default ChequeReferenceFormPage;
