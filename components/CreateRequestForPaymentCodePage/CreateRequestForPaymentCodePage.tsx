...
const CreateRequestForPaymentCodePage = ({ form, connectedRequest }: Props) => {
  ...
  useEffect(() => {
    const fetchFormSections = async () => {
      ...
      try {
        ...
        const typeFieldId = form.form_section[1].section_field[0].field_id;
        const amountFieldId = form.form_section[1].section_field[1].field_id;
        const projectOrDepartmentFieldId =
          ...
          if (uniqueFieldIdList.includes(field.field_id)) {
            ...
            switch (field.field_name) {
              case "Type":
                ...
                field.field_id = typeFieldId;
                break;
              case "Amount":
                field.field_order = 1;
                field.field_is_read_only = true;
                field.field_id = amountFieldId;
                break;
              case "Project / Department":
                field.field_order = 2;
                field.field_is_read_only = true;
                field.field_id = projectOrDepartmentFieldId;
                break;
              default:
                break;
            }
        ...
        const boqFieldList = [
          ...form.form_section[1].section_field.slice(3).map((field) => ({
            ...field,
            field_response: [
              {
                request_response: "",
...
export default CreateRequestForPaymentCodePage;
