import { getAllTeamGroups } from "@/backend/api/get";
...
const TicketRequestToJoinTeamGroup = ({
  category,
  memberId,
  ticketForm,
  isEdit,
        ...
        replaceSection([
          {
            ...
            ticket_section_fields: [
              {
                ...ticketForm.ticket_sections[0].ticket_section_fields[0],
                ticket_field_option: teamGroupList.map((group) => {
                  return {
...
export default TicketRequestToJoinTeamGroup;
