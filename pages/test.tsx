    ...
    try {
      ...
      while (1) {
        const { data: equipmentData, error } = await supabaseClient
          ...
          .select("equipment_description_property_number_with_prefix")
      ...
      const newData = equipmentList.map((equipment) => {
        ...
        if (!matchedPropertyNumber?.acquisitionDate) {
          notFound.push(
            equipment.equipment_description_property_number_with_prefix
          );
        }
        ...
        return {
          ...equipment,
          date: matchedPropertyNumber?.acquisitionDate,
        };
      });
