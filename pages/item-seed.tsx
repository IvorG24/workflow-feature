...
const itemData = [
  ...
  },
  {
    ...
    descriptionField: [
      ...
      ["CALTEX", "DERFOE", "SEGA", "CALTEX", "LIQUI MOLY"],
    ],
  },
  {
  ...
  },
  {
    ...
    descriptionField: [
      ...
      ["WHITE", "GREEN", "RED", "ORANGE", "YELLOW", "GREEN", "BLUE"],
    ],
  },
  {
    generalName: "T SHIRT",
...
const Page = () => {
  ...
  return (
    <>
      <Meta description="Item Seed" url="/item-seed" />
      <Container>
        <Title>Item Seed</Title>
        <Center>
          <Button loading={isSeeding} onClick={handleItemSeed}>
            Seed Item
          </Button>
        </Center>
      </Container>
