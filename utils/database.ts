...
export type Database = {
  public: {
    Tables: {
      ...
      jira_team_project_assigned_user_table: {
        Row: {
        ...
        Relationships: [
          {
            foreignKeyName: "jira_team_project_assigned_u_jira_team_project_assigned_u_fkey1"
            columns: ["jira_team_project_assigned_user_team_project_id"]
            isOneToOne: false
            referencedRelation: "team_project_table"
            referencedColumns: ["team_project_id"]
          },
          ...
          },
          {
            ...
            columns: ["jira_team_project_assigned_user_account_id"]
            isOneToOne: false
