...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      department_signer_table: {
        Row: {
          department_signer_department_id: string
          department_signer_form_id: string
          department_signer_id: string
          department_signer_is_primary: boolean
          department_signer_project_id: string
          department_signer_team_member_id: string
        }
        Insert: {
          department_signer_department_id: string
          department_signer_form_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "department_signer_table_department_signer_department_id_fkey"
            columns: ["department_signer_department_id"]
            isOneToOne: false
            referencedRelation: "team_department_table"
            referencedColumns: ["team_department_id"]
          },
          {
            foreignKeyName: "department_signer_table_department_signer_form_id_fkey"
            columns: ["department_signer_form_id"]
            isOneToOne: false
            referencedRelation: "form_table"
            referencedColumns: ["form_id"]
          },
          {
            foreignKeyName: "department_signer_table_department_signer_project_id_fkey"
            columns: ["department_signer_project_id"]
            isOneToOne: false
            referencedRelation: "team_project_table"
            referencedColumns: ["team_project_id"]
          },
          {
            foreignKeyName: "department_signer_table_department_signer_team_member_id_fkey"
            columns: ["department_signer_team_member_id"]
            isOneToOne: false
            referencedRelation: "team_member_table"
            referencedColumns: ["team_member_id"]
          },
